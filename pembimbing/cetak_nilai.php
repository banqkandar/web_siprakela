        ...
        <div class="row">
            <div class="col-md-5">
                <div class="header-judul">
                    ...
                    <p class="as">Nama Penilai</p><br>
                </div>
            </div>
            <div class="col-md-7">
                <?php
                    $id_nilai = $_GET['id'];
                    $ambil = $con->query("SELECT * FROM penilaian JOIN user USING (id_user) JOIN pengajuan USING (id_pengajuan) JOIN jenis_penelitian USING (id_penelitian) JOIN instansi USING (id_instansi) WHERE id_nilai = '$id_nilai' ");
                    $hasil = $ambil->fetch_assoc();
                ?>
                <div class="isi-identitas">
                    <p class="as">: <?= ucwords($hasil['nama']);?></p>
                    <p class="as">: <?= $hasil['no_induk']; ?></p>
                    <p class="as">: <?= $hasil['nama_instansi']; ?></p>
                    <p class="as">: <?= $hasil['alamat']; ?></p>
                    <p class="as">: <?= $hasil['durasi_penelitian']; ?> Bulan</p>
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="header-judul">
                <p class="as">Nama Mahasiswa/i</p>
                <br><br><br><br><br><br>
                <p class="as">Nama, tanda tangan</p>
            </div>
        </div>
        <div class="col-md-6">
            <div class="header-judul">
                <p class="as">Kepala Pimpinan Kapolres</p>
                <br><br><br><br><br>
                <p class="as"><?= $hasil['nama_pimpinan']?></p>
                <p class="as">Nama, tanda tangan</p>
            </div>
        </div>
    </div>

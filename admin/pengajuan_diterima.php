    ...
    <div class="col-md-12">
      <div class="card mb-4">
        <div class="card-header">
          <h6 class="text-gray">Data pengajuan yang telah diterima</h6>
        </div>
        <div class="card-body">
          <div class="table-responsive">
            <table class="table table-hover" id="dataTable" cellspacing="0">
              ...
              <tbody>
                <?php
                $no = 1;
                $tampil = $con->query("SELECT * FROM pengajuan join jenis_penelitian using(id_penelitian) WHERE status='diterima' ORDER BY id_pengajuan DESC");
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <a href="cancel_pengajuan.php?id=<?= $isi['id_pengajuan']; ?>" class="text-gray-600"><span class="badge badge-secondary">cancel</span></a>
                  </td>
                    <?php
                  }
                  ?>

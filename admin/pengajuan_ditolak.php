    ...
    <div class="col-md-12">
      <div class="card mb-4">
        <div class="card-header">
          <h6 class="text-gray">Data pengajuan yang ditolak</h6>
        </div>
        <div class="card-body">
          <div class="table-responsive">
            <table class="table table-hover" id="dataTable" cellspacing="0">
              ...
              <tbody>
                <?php
                $no = 1;
                $tampil = $con->query("SELECT * FROM pengajuan join jenis_penelitian using(id_penelitian) WHERE status='tidak diterima' ORDER BY id_pengajuan DESC");
